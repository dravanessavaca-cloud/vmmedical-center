...
const Recetas    = () => <ComingSoonPage title="Recetas Médicas" phase={2} features={['Múltiples medicamentos','Imprimir PDF','Firma del médico']} />
const Certs      = () => <ComingSoonPage title="Certificados" phase={2} features={['Certificado de reposo','Certificado de asistencia']} />
                                                                                                                                  ...
                                                                                                                                  <Route path="/agenda" element={<AgendaPage profile={profile} />} />
                                                                                                                                            <Route path="/historias" element={<MedicalRecordPage profile={profile} />} />
                                                                                                                                                      <Route path="/recetas" element={<Recetas />} />
                                                                                                                                                                <Route path="/certificados" element={<Certs />} />
