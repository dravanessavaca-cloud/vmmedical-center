...
interface AvatarProps { name: string; size?: 'sm' | 'md' | 'lg'; color?: string; className?: string }

const COLORS = ['bg-blue-500','bg-teal-600','bg-amber-600','bg-orange-600','bg-purple-600','bg-pink-600']
